...
exports.generateCertificate = async (req, res) => {
  try {
    ...
    if (!updatedCertificate) {
      console.error('Failed to update certificate:', _id);
